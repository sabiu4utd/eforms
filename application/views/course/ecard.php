                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-10">
                                            <hr> <h2 class="text-left" style="font-size:27px;font-weight:bold;">Student Information</h2><hr>
                                            <table style=" width:100%; color:#000; font-size:19px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left;vertical-align:top"><?php echo $student->gender; ?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-10">
                                            <hr> <h2 class="text-left" style="font-size:27px;font-weight:bold;">Courses Registered for <?php echo $courses[0]->value.' Semester, '.$courses[0]->session; ?></h2><hr>
                                            <table style=" width:100%; color:#000; font-size:19px; border-collapse:collapse" border="1">
                                                <tr style="color:#000">
                                                    <th style="color:#000; text-align:center;font-weight:bolder">S/N</th>
                                                    <th style="color:#000; text-align:center; font-weight:bolder">Course Code</th>
                                                    <th style="color:#000; text-align:center; font-weight:bolder">S/N</th>
                                                    <th style="color:#000; text-align:center; font-weight:bolder">Course Code</th>
                                                    <th style="color:#000; text-align:center; font-weight:bolder">S/N</th>
                                                    <th style="color:#000; text-align:center;font-weight:bolder">Course Code</th>
