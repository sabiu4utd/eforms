...
<body class="font-muli theme-cyan gradient">
	<form method="post" action="<?php echo site_url('auth/resetpass');?>" autocomplete="off">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <a class="header-brand" href="#">
                            ...
                            <div class="card-title mt-2">University Portal<br>Reset your Password</div>
                        </a>
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control text-center" placeholder="Enter Your University Email" required name="username" autocomplete="off">
                    </div>
                    <div class="form-group">
