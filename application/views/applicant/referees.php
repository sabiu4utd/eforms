                                ...
                                <div class="col-xl-12">
                                            ...
                                            <a href="#" class="card-options-collapse" data-toggle="card-collapse">
                                                <h3 class="card-title" style="width: 100%; display:flex; justify-content: space-between;">
                                                    ...
                                                    <span style="float: left;">
                                                        <a href="<?php echo site_url('applicant/uploads/' . $_SESSION['activeForm']->order_hash) ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="row form-group">
                                                <div class="col-12 pr-4 mb-4">
                                                    <form method="post" action="<?php echo site_url('applicant/savereferee') ?>" enctype="multipart/form-data">
                                                    <div class="row">
                                                    <div class="col-md-1">
                                                            <label>Title <span class="red">*</span></label>
                                                            <select name="referee_title" required class="form-control">
                                                                <option>Mr</option>
                                                                <option>Dr</option>
                                                                <option>Prof</option>
                                                            </select>
                                                        ...
                                                        <div class="col-md-3">
                                                            <label>Referee Name <span class="red">*</span></label>
                                                            <input type="text" name="referee_name" required placeholder="Enter the Referee Name" class="form-control" />
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label>Rank <span class="red">*</span></label>
                                                            <input type="text" name="referee_rank" required placeholder="Enter the Referee Rank" class="form-control" />
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label>Email <span class="red">*</span></label>
                                                            <input type="email" name="referee_email" required placeholder="Enter the Referee Email" class="form-control" />
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label>Phone <span class="red">*</span></label>
                                                            <input type="phone" name="referee_phone" required placeholder="Enter the Referee Phone" class="form-control" />
                                                        </div>
                                                        <div class="col-md-2" >
                                                        <label>&nbsp; </label>
                                                            <button class="btn btn-primary form-control" type="submit">Add Referee</button>
                                                        </div>
                                                    </div></form>
                                                </div>
                                            ...
                                            <table class="table table-stripped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($referees as $row) { ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?php echo $row->referee_title . ' ' . $row->referee_name; ?></td>
                                                            <td><?php echo $row->referee_email; ?></td>
                                                            <td><?php echo $row->referee_phone; ?></td>
                                                            <td class="text-center"><?php echo $row->completed ?
                                                                                        "<span class='badge badge-success'>YES</span>" :
                                                                                        "<span class='badge badge-danger'>NO</span>"
                                                                                    ?></td>
                                                            <td>
                                                                <a href="<?php echo site_url('applicant/reminder/' . $row->applicant_id.'/'.$row->referee_hash) ?>">
                                                                    <i class="fa fa-alarm-clock"></i> Email Reminder
                                                                </a>
                                                            </td>
                                                            <td class="text-center">
                                                                <a href="<?php echo site_url('applicant/delete_referee/' . $row->id) ?>">
                                    ...
                                    <div class="row form-group clearfix mt-4">
                                        <?php if (!$_SESSION['activeForm']->app_status) { ?>
                                            <div class="col">
                                                <a href="<?php echo site_url('applicant/save_referees_progress/' . $_SESSION['activeForm']->order_hash) ?>" class="btn btn-primary form-control">Save &amp; Continue</a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
